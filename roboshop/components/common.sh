...
sed -i -e 's/MONGO_DNSNAME/mongodb.roboshop.internal/' /home/roboshop/$1/systemd.service &>>$log && mv /home/roboshop/$1/systemd.service /etc/systemd/system/$1.service &>>$log
STAT $?
HEAD  "Setup systemd.service"
